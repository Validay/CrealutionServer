...
{
    public class SickTypeRepositoryTests
    {
        [Fact]
        public async Task GetAll_ShouldReturnAllEntities()
        {
            ...
            var options = new DbContextOptionsBuilder<CrealutionDb>()
               ...
               .Options;
            var entities = new List<SickTypeCreateDto>
            {
                new SickTypeCreateDto
                {
                    Name = "name_1" 
                },
                new SickTypeCreateDto
            ...
            {
                var repository = new SickTypeRepository(
                    TestMapper.Mapper,
        ...
        public async Task GetById_WithExistingId_ShouldReturnEntity()
        {
            ...
            var options = new DbContextOptionsBuilder<CrealutionDb>()
              ...
              .Options;
            var entity = new SickTypeCreateDto
            { 
                Name = "name_1" 
            };
        ...
        public async Task GetById_WithNonExistingId_ShouldThrowEntityNotFoundException()
        {
            ...
            using (var fakeDb = new CrealutionDb(options))
            {
                ...
                await repository.Create(new SickTypeCreateDto 
                { 
                    Name = "name_1" 
                });
        ...
        public async Task Create_ShouldCreateEntity()
        {
            ...
            var options = new DbContextOptionsBuilder<CrealutionDb>()
                ...
                .Options;         
            var createDto = new SickTypeCreateDto
            {
                Name = "New sick type"
            };
        ...
        public async Task Update_DuplicateName_ShouldThrowCrealutionEntityValidateException()
        {
            ...
            var options = new DbContextOptionsBuilder<CrealutionDb>()
                ...
                .Options;
            var createDto1 = new SickTypeCreateDto
            {
                Name = "Name sick type 1"
            };
            var createDto2 = new SickTypeCreateDto
            {
                Name = "Name sick type 2"
            };
            var updateDto = new SickTypeUpdateDto
            {
                Id = 1, 
                Name = "Name sick type 2"
            };
